                ...
                <div class="card main-card shadow-lg mb-4">
                    <div class="card-body">
                        ...
                        <form method="GET" action="lista.php" class="row g-3 mt-3 align-items-center">
                            <div class="col-12 col-md-8 col-lg-<?php echo !empty($searchTerm) ? '7' : '9'; ?> mt-0">
                    ...
                    <div class="card-body pb-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-4 mb-4">
                                <div class="card gift-card h-100 <?php echo $gift['status'] == 1 ? 'purchased' : ''; ?>">
                                    <div class="card-body d-flex flex-column ">
                                        ...
                                        <div class="mt-auto">
                                            ...
                                            <button class="btn btn-outline-secondary w-100 resgatar-btn-resgatado" disabled>
                                                <i class="fas fa-check me-2"></i>
                                                Já presenteado
                                            </button>
                                            <?php else: ?>
                                            <button class="btn btn-primary w-100 resgatar-btn" 
